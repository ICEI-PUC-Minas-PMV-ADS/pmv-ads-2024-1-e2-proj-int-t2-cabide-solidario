...
O propósito deste diagrama é apresentar o estudo do fluxo de interação do usuário com o sistema interativo. Com isto pretendemos permitir que o design das interações seja bem planejado e gere impacto na qualidade no design do wireframe interativo que será desenvolvido logo em seguida.
